...
export COMPILE_OPTIONS=("-DupdatePolicy=never" "-Dmaxmemory=2g" "-Dorg.ops4j.pax.url.mvn.localRepository=$M2_LOCAL_REPOSITORY" "-Daether.connector.basic.threads=1" "-Daether.connector.resumeDownloads=false")
